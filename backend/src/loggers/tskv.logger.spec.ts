...
describe('tests for JSON logger', () => {
  ...
  it('should return JSON formated message', () => {
    ...
    expect(formatedMessage).toEqual(
      `level=log\tmessage=test message\toptionalParams=test param\n`,
    );
  });
  ...
  it('should log warn level message', () => {
    ...
    expect(console.log).toHaveBeenCalledWith(
      `level=warn\tmessage=test message\toptionalParams=test param\n`,
    );
  });
  ...
  it('should log error level message', () => {
    ...
    expect(console.log).toHaveBeenCalledWith(
      `level=error\tmessage=test message\toptionalParams=test param\n`,
    );
  });
});
